package institute.isshoni.test.araragi.core.stream;

import static org.junit.Assert.assertEquals;

import institute.isshoni.araragi.stream.Streams;
import institute.isshoni.test.araragi.model.ClassA;
import institute.isshoni.test.araragi.model.ClassB;
import institute.isshoni.test.araragi.model.ClassC;
import institute.isshoni.test.araragi.model.ParentInterface;
